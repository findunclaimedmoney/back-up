    ...
    <div id="topup" className="rounded-[2rem] border border-border bg-card overflow-hidden scroll-mt-20">
      <div className="p-8">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-6">
          ...
          deducts from your balance based on duration — $90 for 15 min, $180 for
          30 min, $360 for 1 hour. Top up anytime; credit never expires.
        </p>
        ...
        {creditBalance > 0 && (
          <div className="flex items-center gap-2 mt-6 text-xs text-muted-foreground">
            ...
            You have enough credit for {Math.floor(creditBalance / 90)} more session{Math.floor(creditBalance / 90) === 1 ? "" : "s"}.
          </div>
        )}
      </div>
    </div>

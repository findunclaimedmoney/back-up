    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="px-6 py-5 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <img src="https://media.base44.com/images/public/6a4ad4122d2c58f83324b2ce/c9b4df7dc_generated_image.png" alt="GLIMR" className="h-12 w-12" />
      ...
      <footer className="border-t border-border px-6 py-10">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-2">
            <img src="https://media.base44.com/images/public/6a4ad4122d2c58f83324b2ce/c9b4df7dc_generated_image.png" alt="GLIMR" className="h-7 w-auto" />
          </Link>

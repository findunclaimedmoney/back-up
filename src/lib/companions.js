...
export const COMPANIONS = [
  ...
  },
  {
    ...
    description:
      "Natalie is the warmth you sink into at the end of a long day — the soft voice in a dim room. She notices the weight you're carrying and helps you set it down.",
    image:

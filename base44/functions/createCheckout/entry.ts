...
const TIER_CONFIG = {
  ...
  pro: { price: 8900, name: 'GLIMR Pro', description: '160 min HD video, intimacy & romantic layer, fantasy outfits, diary' },
...
const ADDON_CONFIG = {
  ...
  custom_avatar: {
    'single': { price: 9900, name: 'Custom Avatar + Starter Credits', description: 'Create a custom AI companion from your photo ($49) + $19.90 starter credits' },
  },
};
